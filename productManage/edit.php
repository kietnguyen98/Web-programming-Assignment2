    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col align-self-center">
                ...
                <form method="post" action="edit.php?id=<?php echo $data['product_id']; ?>" enctype="multipart/form-data">
                    <table cellspacing="0" cellpadding="10">
                        <tr>
                            <td>Mã Tour</td>
                            <td>
                                <input type="number" name="product_id"
                                    value="<?php echo !empty($data['product_id']) ? $data['product_id'] : ''; ?>" required/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="product_name"
                                    value="<?php echo !empty($data['product_name']) ? $data['product_name'] : ''; ?>" required/>
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea type="text" name="product_description" rows="10" cols="100"
                                    placeholder="<?php echo !empty($data['product_description']) ? $data['product_description'] : ''; ?>" / required></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" name="product_startdate"
                                    value="<?php echo !empty($data['product_startdate']) ? $data['product_startdate'] : ''; ?>" required/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" name="product_enddate"
                                    value="<?php echo !empty($data['product_enddate']) ? $data['product_enddate'] : ''; ?>" required/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="product_price"
                                    value="<?php echo !empty($data['product_price']) ? $data['product_price'] : ''; ?>" required/>
                    ...
                    <input id="add" class="btn btn-primary" onclick="window.location = 'list.php'" type="button"
                        value="Quay lại" />
                    <input id="save" class="btn btn-success" type="submit" name="edit" value="Lưu thông tin" />
                    </div>
                </form>
            </div>
        </div>
